...
// import { API_LISTINGS, apiRequest } from "../shared/apis"; // Adjust the import path as necessary
...
//       try {
//         const response = await apiRequest(API_LISTINGS);
//         // Adjust here to handle the expected data structure
